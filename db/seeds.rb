...
doctor_two = Doctor.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, specialty: "Cardiology", degree: "MD Northwestern", bio: Faker::Lorem.paragraph, residency: "Northwestern", email: "doctor@hospital.com", image: "https://cdn1.edgedatg.com/aws/v2/abc/GreysAnatomy/person/736851/4a4fbc32cbe7d629710d6990978d092b/320x180-Q90_4a4fbc32cbe7d629710d6990978d092b.jpg" )
doctor_three = Doctor.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, specialty: "Orthopedic Surgery", degree: "MD Columbia University", bio: Faker::Lorem.paragraph, residency: "Rush North Shore", email: "doctor@hospital.com", image: "https://www.dailyactor.com/wp-content/uploads/2013/08/sandra-oh-greys-anatomy.jpg" )
doctor_four = Doctor.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, specialty: "Anesthesiology", degree: "MD U of I", bio: Faker::Lorem.paragraph, residency: "Glenbrook", email: "doctor@hospital.com", image: "https://actique.files.wordpress.com/2016/04/gas4meredithgrey1.jpg" )
doctor_five = Doctor.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, specialty: "Internal Medicine", degree: "MD Harvard", bio: Faker::Lorem.paragraph, residency: "General Hospital", email: "doctor@hospital.com", image: "https://www.dailyactor.com/wp-content/uploads/2013/08/sandra-oh-greys-anatomy.jpg" )
